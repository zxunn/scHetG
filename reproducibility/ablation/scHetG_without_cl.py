...
for dataset in ['mouse_pancreas', 'mouse_atlas','human_pancreas','human_pancreas_2','human_lung','human_heart','mouse_brain']:
    ...
    sc.tl.umap(adata)
    sc.pl.umap(adata, color=['batch', 'celltype', 'louvain'], save="scHetG_without_cl"+dataset+".pdf")
    adata.write_h5ad("scHetG_without_cl" + dataset + ari.astype('str')+".h5ad")
