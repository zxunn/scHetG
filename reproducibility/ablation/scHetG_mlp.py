...
for dataset in ['mouse_pancreas', 'mouse_atlas','human_pancreas','human_pancreas_2','human_lung','human_heart','mouse_brain']:
    ...
    #training
    adata = train_scHetG(adata, batch_name, n_clusters=n_clusters, cl_type='celltype', use_graph=False,
    ...
    sc.tl.umap(adata)
    sc.pl.umap(adata, color=['batch', 'celltype', 'louvain'], save="scHetG_mlp"+dataset+".pdf")
    adata.write_h5ad("scHetG_mlp" + dataset + ari.astype('str')+".h5ad")
