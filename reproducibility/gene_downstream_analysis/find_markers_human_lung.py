...
if __name__ == "__main__":
    if os.path.exists("./gene&cell_emb_human_lung_scHetG"):
        ...
        print("Run the gene_co_expression_human_lung.py file first to get the gene embedding file of scHetG")
    if os.path.exists("../../gene&cell_emb_human_lung_SIMBA"):
        SIMBA_data = sc.read_h5ad("../../gene&cell_emb_human_lung_SIMBA") # This data is used to take the names of both scHetG and SIMBA computes the gene embedding
    else:
        print("Run the gene_co_expression_human_lung.py file first to get the gene embedding file of SIMBA")
    ...
    all_known_marker_names = df_plot[df_plot.Geneset.values == "lung macrophage"].index
    sub_known_marker_names =df_plot[df_plot.Geneset.values == "lung macrophage"].index[5:10]
    ...
    weights = np.ones(sub_known_embeddings.shape[0])
